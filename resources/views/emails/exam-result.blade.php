                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
                    ...
                    <tr>
                        ...
                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="left">
                                    <div style="height: 10px; line-height: 60px; font-size: 10px;"> </div>
                                    ...
                                    <div style="line-height: 24px;">
                                        <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
                                            <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                                                Thank you so much for attending this online exam.We hope that this practice helped out for increasing your skill.
                                            </span>
                                        </font>
                                    </div>
                            ...
                            <tr>
                                <td align="center">
                                    <table class="rank-d-wr" align="center" width="80%">
                                        <tr>
                                          <td class="sub-wr">Mark</td>
                                          <td class="data-wr"><?php echo $mark;?></td>
                                        </tr>
                                        <tr>
                                          <td class="sub-wr">Negative Mark</td>
                                          <td class="data-wr"><?php echo $negative_mark;?></td>
                                        </tr>                                        
                                        <tr>
                                          <td class="sub-wr">Remark</td>
                                          <td class="data-wr"><?php echo $remarks;?></td>
                                        </tr>
                                        <tr>
                                          <td class="sub-wr">Atten Date</td>
                                          <td class="data-wr"><?php echo $attended_date;?></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr> 
                            ...
                            <tr>
                                <td align="center">
                                    <div style="line-height: 24px;">
                                        <a href="http://bestshineeducationcampus.com" target="_blank" class="get-more-ex-btn">Get more exam</a>
                                    </div>
                                    <div style="height: 20px; line-height: 40px; font-size: 10px;"> </div>
                                </td>
                            </tr>    

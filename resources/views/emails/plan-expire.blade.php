                    ...
                    <tr>
                        ...
                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <div style="line-height: 24px;">
                                        <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
                                            <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                                                Your plan will get expire soon to continue with us, Please Subscribe
                                            </span>
                                        </font>
                                    </div>
                            ...
                            <tr>
                                <td align="center">
                                    <div style="line-height: 24px;">
                                        <a href="http://bestshineeducationcampus.com" target="_blank" class="view-plan-btn">View Plans</a>
                                    </div>
                                    <div style="height: 20px; line-height: 40px; font-size: 10px;"> </div>
                                </td>
                            </tr>    

...
<body>
    ...
    <section class="analy-wr pad-t-3 mr-b-0" id="analy-wr">
        <div class="container">
            ...
            <div class="col-md-6 text-center analyzer-img-wr">
    ...
    <section class="neet-cls-feature-wr mr-t-0">
        <div class="container">
            <div class="neet-cls-feature-in">
                <h3>NEET Online Test Prep Advantage</h3>
                <ul class="col-md-12">
                    <li class="col-md-6">
                        ...
                        <div class="col-md-9">
                            <span class="sub-hd">Lorem Ipsum</span>
    ...
    <section class="include-test-wr pad-t-3">
        <div class="container">
            <div class="row"> 
                <div class="col-md-6 include-list-wr">
                <h3>NEET Online test Prep Advantage</h3>
                ...
                <div class="col-md-6 include-cont">
                    ...
                    <a class="Singup-a btn" href="#">Sing up</a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="tabbable tabs-left col-md-12 pad-t-3">
                        <div class="side-bar col-md-3">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#" data-toggle="tab">Engineering Entrance </a></li>
                                <li><a href="#" data-toggle="tab">MBA Entrance</a></li>
                                <li><a href="#" data-toggle="tab">Law Entrance</a></li>
                            </ul>
                        </div>
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="fb-content col-md-12 pad-t-3">
                            Seat Reservation are offered to   candidates applying for the 15% All India Quota Seats. Different percentage of seats is given to various categories such as Schedule Caste, Schedule Tribe, OBC and Physic
                        </div>
                    </div>
                ...
                <div class="container text-center">
                    <div class="col-md-12">
                        <ul class="footTop">
                            ...
                            <li><a href="#scroll-exam">Exam</a></li>
                    ...
                    <p>© {{ date('Y') }} BESTSHINE EDUCATION CAMPUS PRIVATE LIMITED</p>
